pipeline {
  ...
  stages {
    ...
    stage('RunDASTUsingZAP') {
      steps {
        bat("C:\\ZAP_2.16.1_Crossplatform\\ZAP_2.16.1\\zap.sh -port 9393 -cmd -quickurl https://www.example.com -quickprogress -quickout C:\\ZAP_2.16.1_Crossplatform\\ZAP_2.16.1\\Output.html")
      }
    }
